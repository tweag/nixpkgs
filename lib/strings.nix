...
rec {
  ...
  */
  ...
  /* See `lib.paths.makeSearchPath` instead */
  makeSearchPath = lib.paths.makeSearchPath;

  /* See `lib.paths.makeSearchPathOutput` instead */
  makeSearchPathOutput = lib.paths.makeSearchPathOutput;

  /* See `lib.paths.makeLibraryPath` instead */
  makeLibraryPath = lib.paths.makeLibraryPath;

  /* See `lib.paths.makeBinPath` instead */
  makeBinPath = lib.paths.makeBinPath;

  /* See `lib.paths.normalizePath` instead */
  normalizePath = lib.paths.normalizePath;
  ...
  */
  ...
  /* See `lib.paths.isStorePath` instead */
  isStorePath = lib.paths.isStorePath;
