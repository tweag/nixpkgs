...
self: super:
{
  ...
  dunai = doJailbreak (
    addBuildDepend self.list-transformer (enableCabalFlag "list-transformer" super.dunai)
  );
  ...
  Cabal_3_14_0_0 = doDistribute (
    super.Cabal_3_14_0_0.override {
  ...
  monad-schedule =
    assert super.monad-schedule.version == "0.1.2.2";
    doDistribute self.monad-schedule_0_2_0_1;
  ...
  hnix-store-core_0_8_0_0 = super.hnix-store-core_0_8_0_0.override {
    dependent-sum-template = self.dependent-sum-template_0_2_0_1;
  };
  ...
  pipes-extras =
    assert super.pipes-extras.version == "1.0.15";
    doJailbreak super.pipes-extras;
  ...
  darcs = super.darcs.overrideScope (
    self: super: {
  ...
  diohsc = super.diohsc.overrideScope (
    self: super: {
      tls = self.tls_2_0_6;
    }
  );
  ...
  gi-gtk_4_0_9 = doDistribute (
    super.gi-gtk_4_0_9.override {
  ...
  ghc-syntax-highlighter_0_0_12_0 = super.ghc-syntax-highlighter_0_0_12_0.overrideScope (
    self: super: {
